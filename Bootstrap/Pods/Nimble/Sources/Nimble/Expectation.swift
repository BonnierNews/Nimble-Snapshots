internal func execute<T>(_ expression: Expression<T>, _ style: ExpectationStyle, _ predicate: Nimble.Predicate<T>, to: String, description: String?, captureExceptions: Bool = true) -> (Bool, FailureMessage) {
...
public struct Expectation<T> {
    ...
    @discardableResult
    public func to(_ predicate: Nimble.Predicate<T>, description: String? = nil) -> Self {
    ...
    @discardableResult
    public func toNot(_ predicate: Nimble.Predicate<T>, description: String? = nil) -> Self {
    ...
    /// Alias to toNot().
    @discardableResult
    public func notTo(_ predicate: Nimble.Predicate<T>, description: String? = nil) -> Self {
